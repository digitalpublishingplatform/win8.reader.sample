                ...
                WinJS.Resources.processAll().then(function() {
                    ...
                    WinJS.Application.onsettings = function (e) {
                        e.detail.applicationcommands = {
                            "aboutDiv": { title: DigitalPublishingPlatform.Tools.GetString("About") }
                        };
                    ...
                    document.getElementById("aboutVersion").innerText = DigitalPublishingPlatform.Tools.GetString("Version") + " " + version.major + "." + version.minor + "." + version.build + "." + version.revision;
